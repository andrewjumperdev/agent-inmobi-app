    ...
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap gap-1.5">
        {pillars.map((p) => {
          ...
          const color = p !== "all" ? PILLAR_COLORS[p as ContentPillar] : "#909097";
          return (
            <button
              key={p}
              onClick={() => onPillar(p)}
              className="flex items-center gap-1.5 rounded-lg border px-2.5 py-1 font-label text-[10px] uppercase tracking-widest transition-all"
              style={{
                borderColor: active ? `${color}50` : "rgba(69,70,77,0.4)",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderColor: "rgba(69,70,77,0.25)" }}
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            style={{
              borderColor: copied ? "rgba(34,197,94,0.4)" : "rgba(69,70,77,0.4)",
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="font-headline text-base font-bold" style={{ color: "#dae2fd" }}>
        El banco está vacío
      </p>
      ...
      <div className="flex items-start justify-between">
        ...
        {piezas.length > 0 && (
          ...
          >
            ...
            <p className="font-label text-[10px] uppercase tracking-widest" style={{ color: "#909097" }}>
              piezas
            </p>
          </div>
        )}
